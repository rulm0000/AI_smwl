...
5. **Cohen's d decomposition** (`7_Cohens_d_Decomposition.do`)
...
Results will be saved under the `output/` folder. The master pipeline generates tables plus the manuscript Figure 2 under `figures/human_generated_vs_ai_generated/`.
...
The only manuscript figure generated by `0_Master.do` is saved as:

- `output/figures/human_generated_vs_ai_generated/Figure2_Human_AI_Means_Researcher_vs_AI_Refined.png`
